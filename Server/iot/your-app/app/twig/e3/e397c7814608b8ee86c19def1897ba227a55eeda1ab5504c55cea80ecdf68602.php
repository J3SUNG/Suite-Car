...
/* heart_chart.twig */
class __TwigTemplate_055b672b94094c2c9e1ece3f0be11cbdf73efa86e56552950233be017feab426 extends Twig_Template
{
...
<body class=\"animsition\">
                                        ...
                                        function drawChart() {
                                            ...
                                            if(jsonData != \"\"){
                                                ...
                                                for(var i=0; i<\$json_data.rows.length; ++i){
                                                    AVG += \$json_data.rows[i].c[1].v;
                                                    
                                                    if(\$json_data.rows[i].c[1].v > MAX){
                                                        MAX = \$json_data.rows[i].c[1].v;
                                                    }
                                                    if(\$json_data.rows[i].c[1].v < MIN || MIN == 0) { 
                                                        MIN = \$json_data.rows[i].c[1].v;
                                                    }
                                                }
                                                AVG /= \$json_data.rows.length;
                                                AVG = AVG.toFixed(1);
                                                \$('.AVG').text(AVG);
                                                \$('.MAX').text(MAX);
                                                \$('.MIN').text(MIN);
    ...
    {
        return array (  181 => 152,  128 => 102,  123 => 100,  109 => 89,  19 => 1,);
    }
}
/* <html lang="en">*/
/* */
